...
__global__ void escoamento_monofasico(	ESTRUTURA_Q dev_q,
										...
										ESTRUTURA_PRESSAO dev_pressao,
										ESTRUTURA_MAT dev_mat,
										float *dev_aux, const float erro_max, float erro){
	...
	float media = 0.0, dev_sum1 = 0.0, dev_sum2 = 0.0;
	...
	while(i < 1500){
		...
		*/
		...
		if(tid == eq_tid_cant_inf_dir){
			media = 0.0, dev_sum1 = 0.0, dev_sum2 = 0.0, erro = 0.0;
			int i = 0;
			for(i = 0; i <= eq_tid_cant_inf_dir; i++){
				media = media + dev_pressao.p[i];
			}
			media = media / (eq_tid_cant_inf_dir + 1);
		}
		__syncthreads();
		dev_pressao.p[index_mem_central] -= media;
		dev_l.D[index_mem_central] -= media;
		dev_l.U[index_mem_central] -= media;
		dev_l.L[index_mem_central] -= media;
		dev_l.R[index_mem_central] -= media;
		...
		if(tid == eq_tid_cant_inf_dir){
			...
			for(i = 0; i <= eq_tid_cant_inf_dir; i++){
				...
				dev_sum2 += dev_pressao.p[i] * dev_pressao.p[i];
			}
			erro = sqrt(dev_sum1/dev_sum2);
		}
		__syncthreads();
		/*
		if (erro > erro_max){
		...
		dev_pressao.p_old[index_mem_central] = dev_pressao.p_old[index_mem_central];
...
// 	dim3 thread(16, 16);
	...
	for(i = 0; i < tam_mat_real; i ++){
		for(j = 0; j < tam_mat_real; j++)
			printf("%-+1.e ", host_mat.font[i*tam_mat_real + j]);
		printf("\n");
	}
	...
	for(i = 0; i < tam_mat_real; i ++){
		for(j = 0; j < tam_mat_real; j++)
			printf("%-+1.e ", host_mat.perm[i*tam_mat_real + j]);
		printf("\n");
	}
	...
	for(i = 0; i < tam_mat_real; i ++){
		for(j = 0; j < tam_mat_real; j++)
			printf("%-+1.e ", host_mat.epsilon[i*tam_mat_real + j]);
		printf("\n");
	}
	...
	for(i = 0; i < tam_mat_real; i ++){
		for(j = 0; j < tam_mat_real; j++)
			printf("%-+1.e ", host_b.U[i*tam_mat_real + j]);
		printf("| ");
		for(j = 0; j < tam_mat_real; j++)
			printf("%-+1.e ", host_b.U_old[i*tam_mat_real + j]);
		printf("\n");
	}
	...
	for(i = 0; i < tam_mat_real; i ++){
		for(j = 0; j < tam_mat_real; j++)
			printf("%-+1.e ", host_b.R[i*tam_mat_real + j]);
		printf("| ");
		for(j = 0; j < tam_mat_real; j++)
			printf("%-+1.e ", host_b.R_old[i*tam_mat_real + j]);
		printf("\n");
	}
	...
	for(i = 0; i < tam_mat_real; i ++){
		for(j = 0; j < tam_mat_real; j++)
			printf("%-+1.e ", host_b.D[i*tam_mat_real + j]);
		printf("| ");
		for(j = 0; j < tam_mat_real; j++)
			printf("%-+1.e ", host_b.D_old[i*tam_mat_real + j]);
		printf("\n");
	}
	...
	for(i = 0; i < tam_mat_real; i ++){
		for(j = 0; j < tam_mat_real; j++)
			printf("%-+1.e ", host_pressao.p[i*tam_mat_real + j]);
		printf("| ");
		for(j = 0; j < tam_mat_real; j++)
			printf("%-+1.e ", host_pressao.p_old[i*tam_mat_real + j]);
		printf("\n");
	}
	printf("\n------------------------------------------------------------------------------------------------------------------------------------------\n");
	printf("\n\n\t\t\t\tl_U:\t\t\t\t\t\t\t\t\tl_U_old:\n");
	for(i = 0; i < tam_mat_real; i ++){
		for(j = 0; j < tam_mat_real; j++)
			printf("%-+1.e ", host_l.U[i*tam_mat_real + j]);
		printf("| ");
		for(j = 0; j < tam_mat_real; j++)
			printf("%-+1.e ", host_l.U_old[i*tam_mat_real + j]);
		printf("\n");
	}
	printf("\n\n\t\t\t\tl_R:\t\t\t\t\t\t\t\t\tl_R_old:\n");
	for(i = 0; i < tam_mat_real; i ++){
		for(j = 0; j < tam_mat_real; j++)
			printf("%-+1.e ", host_l.R[i*tam_mat_real + j]);
		printf("| ");
		for(j = 0; j < tam_mat_real; j++)
			printf("%-+1.e ", host_l.R_old[i*tam_mat_real + j]);
		printf("\n");
	}
	printf("\n\n\t\t\t\tl_D:\t\t\t\t\t\t\t\t\tl_D_old:\n");
	for(i = 0; i < tam_mat_real; i ++){
		for(j = 0; j < tam_mat_real; j++)
			printf("%-+1.e ", host_l.D[i*tam_mat_real + j]);
		printf("| ");
		for(j = 0; j < tam_mat_real; j++)
			printf("%-+1.e ", host_l.D_old[i*tam_mat_real + j]);
		printf("\n");
	}
	printf("\n\n\t\t\t\tl_L:\t\t\t\t\t\t\t\t\tl_L_old:\n");
	for(i = 0; i < tam_mat_real; i ++){
		for(j = 0; j < tam_mat_real; j++)
			printf("%-+1.e ", host_l.L[i*tam_mat_real + j]);
		printf("| ");
		for(j = 0; j < tam_mat_real; j++)
			printf("%-+1.e ", host_l.L_old[i*tam_mat_real + j]);
		printf("\n");
	}
	printf("\n------------------------------------------------------------------------------------------------------------------------------------------\n");
	printf("\n\n\t\t\t\tq_U:\t\t\t\t\t\t\t\t\tq_U_old:\n");
	for(i = 0; i < tam_mat_real; i ++){
		for(j = 0; j < tam_mat_real; j++)
			printf("%-+1.e ", host_q.U[i*tam_mat_real + j]);
		printf("| ");
		for(j = 0; j < tam_mat_real; j++)
			printf("%-+1.e ", host_q.U_old[i*tam_mat_real + j]);
		printf("\n");
	}
	printf("\n\n\t\t\t\tq_R:\t\t\t\t\t\t\t\t\tq_R_old:\n");
	for(i = 0; i < tam_mat_real; i ++){
		for(j = 0; j < tam_mat_real; j++)
			printf("%-+1.e ", host_q.R[i*tam_mat_real + j]);
		printf("| ");
		for(j = 0; j < tam_mat_real; j++)
			printf("%-+1.e ", host_q.R_old[i*tam_mat_real + j]);
		printf("\n");
	}
	printf("\n\n\t\t\t\tq_D:\t\t\t\t\t\t\t\t\tq_D_old:\n");
	for(i = 0; i < tam_mat_real; i ++){
		for(j = 0; j < tam_mat_real; j++)
			printf("%-+1.e ", host_q.D[i*tam_mat_real + j]);
		printf("| ");
		for(j = 0; j < tam_mat_real; j++)
			printf("%-+1.e ", host_q.D_old[i*tam_mat_real + j]);
		printf("\n");
	}
	...
	for(i = 0; i < tam_mat_real; i ++){
		for(j = 0; j < tam_mat_real; j++)
			printf("%-+1.e ", host_q.L[i*tam_mat_real + j]);
		printf("| ");
		for(j = 0; j < tam_mat_real; j++)
			printf("%-+1.e ", host_q.L_old[i*tam_mat_real + j]);
		printf("\n");
	}
...
char inicializa_parametros(){
	...
	HANDLE_ERROR( cudaMalloc( (void**)&erro, sizeof(float) ) );
	int i = 0;
	switch(op_contorno){
